...
public class LunchTestData {
    ...
    public static final int LUNCH_TODAY_ID = START_SEQ + 8;
    ...
    public static final Lunch LUNCH_TODAY = new Lunch(LUNCH_TODAY_ID, 2000.0, "Сегодняшний ланч", now());

    public static final List<Lunch> LUNCHES = List.of(LUNCH_TODAY, LUNCH6, LUNCH5, LUNCH4, LUNCH3, LUNCH2, LUNCH1);

    public static Lunch getNew() {
        return new Lunch(null, 2000.0, "Созданный ланч", of(2015, Month.JUNE, 1));
    }
